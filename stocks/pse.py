"""
Created on Tue 11/11/2023

@authors: Jasper Rebong
"""
...
from stocks.phisix import get_phisix_data
...
def get_stock_table(stock_table_fp=None):
    ...
    for p in range(1, 7):
        ...
        stock_table = pd.concat([stock_table, page_df])
...
def update_pse_data_cache(start_date="2020-01-01", verbose=True, cache_fp=None):
    """
